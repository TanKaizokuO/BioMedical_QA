...
- [ ] Paper: report hit@5 = 0.86 in Table 1 and in G1's row beside the relaxed k, per ADR-0015 §3. The relaxation is stated as a relaxation.
- [ ] Generation stage takes a **10-passage** context wherever G1's k binds; prompt budgets in the W3 drafting item assume that, not 5.
